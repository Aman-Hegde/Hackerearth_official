...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <motion.aside
        className={`fixed top-56 left-4 h-[calc(45vh-2rem)] bg-white dark:bg-black border dark:border-gray-800 z-50 transition-all duration-300 ease-out rounded-2xl
